...
class FlipCard extends StatefulWidget {
  ...
  const FlipCard({Key key, this.frontWidget, this.backWidget, this.controller}) : super(key: key);
...
class _FlipCardState extends State<FlipCard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
      ...
      builder: (context, child) {
        final angel = 2 * controller.value * -pi;
        final transform = Matrix4.identity()
          ..setEntry(3, 2, 0.001)
          ..rotateY(angel);
        return isFrontImage(angel.abs())
            ? widget.frontWidget
            : Transform(alignment: FractionalOffset.center, transform: transform, child: widget.backWidget);
      });
}

bool isFrontImage(double angel) {
  const degrees90 = pi / 2;
  const degrees270 = 10 * pi / 2;

  return angel <= degrees90 || angel >= degrees270;
}
...
class _FadeInDownState extends State<FadeInDown> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    opacity = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(parent: controller, curve: Interval(0, 0.65)));
...
class _FadeInUpState extends State<FadeInUp> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation =
        Tween<double>(begin: widget.from, end: 0).animate(CurvedAnimation(parent: controller, curve: Curves.easeOut));
    opacity = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(parent: controller, curve: Interval(0, 0.65)));
...
class _BounceInDownState extends State<BounceInDown> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget child) {
          return Transform.translate(
              offset: Offset(0, animation.value), child: Opacity(opacity: opacity.value, child: widget.child));
        });
  }
}
...
class _ElasticInState extends State<ElasticIn> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    opacity = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(parent: controller, curve: Interval(0, 0.45)));
...
class _ElasticInDownState extends State<ElasticInDown> with SingleTickerProviderStateMixin {
  AnimationController controller;
  Animation<double> bouncing;
  ...
  void initState() {
    ...
    falling = Tween<double>(begin: widget.from * -1, end: widget.to * -1)
        .animate(CurvedAnimation(parent: controller, curve: Interval(0, 0.30, curve: Curves.linear)));

    bouncing = Tween<double>(begin: widget.to * -1, end: 0)
        .animate(CurvedAnimation(parent: controller, curve: Interval(0.30, 1, curve: Curves.elasticOut)));
...
class _ElasticInLeftState extends State<ElasticInLeft> with SingleTickerProviderStateMixin {
  AnimationController controller;
  Animation<double> bouncing;
  Animation<double> falling;
  Animation<double> opacity;
...
class _FlipInXState extends State<FlipInX> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    rotation =
        Tween<double>(begin: 1.5, end: 0.0).animate(CurvedAnimation(parent: controller, curve: Curves.bounceOut));
...
class _BounceState extends State<Bounce> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget child) {
          return Transform.translate(
              offset: Offset(0, (animationUp.value == (widget.from * -1)) ? animationBounce.value : animationUp.value),
              child: widget.child);
        });
  }
}
...
class _FlashState extends State<Flash> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    opacityOut1 =
        Tween<double>(begin: 1, end: 0).animate(CurvedAnimation(parent: controller, curve: Interval(0, 0.25)));
    opacityIn1 =
        Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(parent: controller, curve: Interval(0.25, 0.5)));
    opacityOut2 =
        Tween<double>(begin: 1, end: 0).animate(CurvedAnimation(parent: controller, curve: Interval(0.5, 0.75)));
...
class _SwingState extends State<Swing> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animationRotation1 = Tween<double>(begin: 0, end: -0.5)
        .animate(CurvedAnimation(parent: controller, curve: Interval(0, 0.1666, curve: Curves.easeOut)));

    animationRotation2 = Tween<double>(begin: -0.5, end: 0.5)
        .animate(CurvedAnimation(parent: controller, curve: Interval(0.1666, 0.3333, curve: Curves.easeInOut)));

    animationRotation3 = Tween<double>(begin: 0.5, end: -0.5)
        .animate(CurvedAnimation(parent: controller, curve: Interval(0.3333, 0.4999, curve: Curves.easeInOut)));

    animationRotation4 = Tween<double>(begin: -0.5, end: 0.4)
        .animate(CurvedAnimation(parent: controller, curve: Interval(0.4999, 0.6666, curve: Curves.easeInOut)));

    animationRotation5 = Tween<double>(begin: 0.4, end: -0.4)
        .animate(CurvedAnimation(parent: controller, curve: Interval(0.6666, 0.8333, curve: Curves.easeInOut)));

    animationRotation6 = Tween<double>(begin: -0.4, end: 0)
        .animate(CurvedAnimation(parent: controller, curve: Interval(0.8333, 1, curve: Curves.easeOut)));
...
class _DanceState extends State<Dance> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    step1 = Tween<double>(begin: 0, end: -0.2)
        .animate(CurvedAnimation(parent: controller, curve: Interval(0, 0.3333, curve: Curves.bounceOut)));

    step2 = Tween<double>(begin: -0.2, end: 0.2)
        .animate(CurvedAnimation(parent: controller, curve: Interval(0.3333, 0.6666, curve: Curves.bounceOut)));

    step3 = Tween<double>(begin: 0.2, end: 0)
        .animate(CurvedAnimation(parent: controller, curve: Interval(0.6666, 1, curve: Curves.bounceOut)));
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget child) {
          ...
          return Transform(
              alignment: FractionalOffset.center, transform: Matrix4.skew(0, animation), child: widget.child);
        });
  }
}
...
class _FadeOutDownState extends State<FadeOutDown> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation =
        Tween<double>(begin: 0, end: widget.from).animate(CurvedAnimation(parent: controller, curve: Curves.easeOut));

    opacity =
        Tween<double>(begin: 1.0, end: 0.0).animate(CurvedAnimation(parent: controller, curve: Interval(0, 0.65)));
